...
| `snapshot-test.spec.mjs` | Vitest- or node-test–compatible test that fails loudly on any unintended rendering drift. |
...
3. Wire `snapshot-test.spec.mjs` into CI. Block merges on test failure.
